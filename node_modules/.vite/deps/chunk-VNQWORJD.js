...
var _current, _previous, _callbacks, _pending, _deferred, _neutered, _async_effects, _boundary_async_effects, _render_effects, _effects, _block_effects, _Batch_instances, process_fn, traverse_effect_tree_fn, commit_fn;
      ...
      while (queued_root_effects.length > 0) {
        if (flush_count++ > 1e3) {
          if (true_default) {
            ...
            for (const source2 of __privateGet(this, _current).keys()) {
...
function destroy_effect_children(signal, remove_dom = false) {
  ...
  while (effect2 !== null) {
    (_a = effect2.ac) == null ? void 0 : _a.abort(STALE_REACTION);
...
function get(signal) {
  ...
  if (true_default) {
    if (current_async_effect) {
      ...
      var was_read = (_a = current_async_effect.deps) == null ? void 0 : _a.includes(signal);
  ...
  if (is_destroying_effect) {
    ...
    derived2 = /** @type {Derived} */
    signal;
    if ((_b = batch_deriveds) == null ? void 0 : _b.has(derived2)) {
...
//# sourceMappingURL=chunk-VNQWORJD.js.map
